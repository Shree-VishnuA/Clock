...
function Sidebar() {
  return (
    <div className="fixed w-screen justify-evenly items-center sm:h-[100vh] h-20 sm:w-25 bg-pink-200 flex sm:flex-col  sm:justify-evenly z-100 sm:items-center backdrop-blur-4xl border-b-2 sm:border-b-0 sm:border-r-2 border-black">
      <NavLink to={"/"}>
